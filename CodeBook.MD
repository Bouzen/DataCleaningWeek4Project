...
1. Dataset was orginally split into subject, activity,  features, and test/training. I binded these data together.

2. Merged on nice activity name

3. Filterd to only mean or standard deveiation measrures. Dataset was merged with derived feature code lookup table to get featureName.

4. An average was added per group of subject, activity, and measure

5. The dataset is then written to `tidy.txt` file

Data
----
This is from the original readme.txt.
